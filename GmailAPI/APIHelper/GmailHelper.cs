...
namespace GmailAPI.APIHelper
{
    public static class GmailAPIHelper
    {
        ...
        {
            Console.WriteLine(Directory.GetParent(Directory.GetParent(Directory.GetCurrentDirectory()).ToString()) + Convert.ToString(ConfigurationManager.AppSettings["ClientInfo"]));
           string secretsPath = Directory.GetParent(Directory.GetParent(Directory.GetCurrentDirectory()).ToString()) + Convert.ToString(ConfigurationManager.AppSettings["ClientInfo"]);

            UserCredential credential;
            using (FileStream stream = new FileStream(secretsPath, 
